...
class AtsAnalyzer {
  ...
  openPdfReportModal(blobUrl, fileName, doc, score, candidateName) {
    let modal = document.getElementById('atsReportModal');
    if (!modal) {
      modal = document.createElement('div');
      modal.className = 'modal-overlay';
      modal.id = 'atsReportModal';
      modal.innerHTML = `
        <div class="modal-panel glass-card ats-report-modal-panel">
          <div class="modal-header">
            <div class="modal-title-group">
              <svg viewBox="0 0 24 24" fill="none" stroke="#B9824A" stroke-width="2" width="18" height="18"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
              <div>
                <h3 id="atsReportModalTitle" style="margin:0;font-size:1.05rem;font-weight:700;">ATS Diagnostic Report</h3>
                <span class="modal-subtitle" id="atsReportModalSubtitle">Vector PDF generated by ResuAI Diagnostic Engine</span>
              </div>
            </div>
            <div class="modal-header-actions" style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
              <button type="button" class="btn-primary-action" id="btnDownloadAtsPdfModal" style="padding:6px 12px;font-size:0.85rem;">
